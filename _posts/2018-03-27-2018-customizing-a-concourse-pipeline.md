...
Lets go over a few principles that we will need when customizing a pipeline. 
...
credhub set --type certificate --name '/concourse/main/credhub_ca' \
...
name: /concourse/main/credhub_ca
type: certificate
value:
  ca: |+
    -----BEGIN CERTIFICATE-----
